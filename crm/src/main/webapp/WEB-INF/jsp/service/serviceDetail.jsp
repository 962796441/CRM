	...
	<div class="serviceDetails2_content" style="">
		<div class="serviceDetails2_content_top">
			<div class="serviceDetails2_content_top_left">
				<ul>
					<li>客户名：${cstService.svrCustName}</li>
					<li>服务类型：${cstService.svrType}</li>
					<li>概要：${cstService.svrTitle}</li>
				</ul>
			</div>
			<div class="serviceDetails2_content_top_right">
				<ul>
					<li>处理人：${cstService.svrDispose}</li>
					<li>服务状态：${cstService.svrStatus}</li>
					<li>客户满意度：${cstService.svrSatisfy}</li>
		...
		<div class="serviceDetails2_content_bottom">
			<span>服务请求：${cstService.svrRequest}</span><br> <span>服务处理过程：${cstService.svrHandle}</span><br>
			<span>服务处理结果：${cstService.svrResult}</span>
		</div>
	</div>
