				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<c:if test="${user.usrRoleId==4 || user.usrRoleId==3 }">
						<li class="layui-nav-item layui-nav-itemed"><a
							href="javascript:;">营销管理</a>
							<dl class="layui-nav-child">
								<c:if test="${user.usrRoleId==3}">
									<dd>
										<a href="javascript:;">销售商机管理</a>
									</dd>
								</c:if>
								<c:if test="${user.usrRoleId==4 }">
									<dd>
										<a href="javascript:;">商机开发计划</a>
									</dd>
								</c:if>
							</dl></li>
					</c:if>
					<c:if test="${user.usrRoleId==4 }">
						<li class="layui-nav-item"><a href="javascript:;">客户管理</a>
							<dl class="layui-nav-child">
								<dd>
									<a href="javascript:;">客户信息查询</a>
								</dd>
							</dl></li>
					</c:if>
					<c:if test="${user.usrRoleId==4 || user.usrRoleId==3 }">
						<li class="layui-nav-item"><a href="javascript:;">服务管理</a>
							<dl class="layui-nav-child">
								<c:if test="${user.usrRoleId==3 }">
									<dd>
										<a href="javascript:;">服务反馈</a>
									</dd>
								</c:if>
								<c:if test="${user.usrRoleId==4 }">
									<dd>
										<a href="javascript:;">服务处理</a>
									</dd>
								</c:if>
							</dl></li>
					</c:if>
					<c:if test="${user.usrRoleId==2 }">
						<li class="layui-nav-item"><a href="javascript:;">统计报表</a>
							<dl class="layui-nav-child">
								<dd>
									<a href="javascript:;">客户贡献分析</a>
								</dd>
								<dd>
									<a href="javascript:;">客户构成分析</a>
								</dd>
							</dl></li>
					</c:if>
